...
<div style="position: relative; display: inline-block; text-align: center;">
  ...
  <h3 style="position: absolute; top: 48%; left: 50%; transform: translate(-50%, -50%);
             color: white; font-size: 40px; font-weight: bold; white-space: nowrap;">
...
::: {.float-image style="display: flex; align-items: flex-start;"}
```{r out.width = '80', out.extra = 'style="float:left; padding-right:10px"', echo = FALSE}
...
| in prep. | <span style="font-weight:bold; color: #06283D; ">Yamada T</span>\* et al.<br />Fragmentation status in spawning habitat of anadromous salmonids. |

### – Published
| | |
| :- | :---------------- |
| 2024 | <span style="font-weight:bold; color: #06283D; ">Yamada T</span>\*, Nobetsu T, Urabe H, & Nakamura F.<br />Invasion status of hatchery-origin pink salmon in an unstocked river at the Shiretoko World Natural Heritage Site in northern Japan.<br />*Journal of Fish Biology* 104(5): 1633–1637. <u>[Link](https://doi.org/10.1111/jfb.15690)</u> |
| 2024 | <span style="font-weight:bold; color: #06283D; ">Yamada T</span>\*, Urabe H, & Nakamura F.<br />Pink salmon productivity is driven by catchment hydrogeomorphology and can decline under a changing climate.<br />*Freshwater Biology* 69(3): 376–386. <u>[Link](https://doi.org/10.1111/fwb.14217)</u> |
