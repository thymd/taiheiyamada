...
<div style="position: relative; display: inline-block; text-align: center;">
  ...
  <h3 style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
             color: white; font-size: 3em; font-weight: bold; white-space: nowrap;">
...
<div>
<span style="font-size:20px; "> 山田 太平 / Taihei Yamada, Ph.D.</span> &nbsp;
</div>
...
::: {.float-image style="display: flex; align-items: center;"}
```{r out.width = '80', out.extra = 'style="float:left; margin-right:20px; margin-left:10px"', echo = FALSE}
